...
@click.option("--no-interactive-plot", is_flag=True, show_default=True, default=False, help="Suppress interactive display of results")
def parse_args(max_files, plot_event, data_dir, epochs, fig_filename, data_type, no_interactive_plot):
    ...
    opts['no_plot']      = no_interactive_plot
    raise HackClick
